...
const Admin = () => {
    return (
        <div className='flex flex-col items-center justify-center h-screen bg-gradient-to-r from-blue-200 to-blue-500'>
            ...
            <h2 className='mb-5 text-2xl font-bold text-white'>Welcome to Your Admin Portal!</h2>
            <div className='flex flex-col'>
                ...
                <Link href='/add-admin' className='mb-3 p-2 bg-blue-500 text-white rounded hover:bg-blue-700 text-center'>
                    Add Admin
                </Link>
                <Link href='/add-employee' className='mb-3 p-2 bg-blue-500 text-white rounded hover:bg-blue-700 text-center'>
                    Add Employee
                </Link>
